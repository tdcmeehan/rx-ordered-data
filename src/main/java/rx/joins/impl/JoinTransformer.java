...
import rx.operators.AggregationOperators;
import rx.operators.OrderedZipOperators;
...
public class JoinTransformer<KEY, LEFT_VALUE, RIGHT_VALUE, RESULT> implements Observable.Transformer<LEFT_VALUE, RESULT> {
     ...
     * on the join type, null left or right side values are permitted; see {@link conductor.rx.ordered.flow.join.JoinType}
     * for more details.
